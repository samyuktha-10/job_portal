...
class JobAdmin(admin.ModelAdmin):
    list_display = ('job_title', 'posted_by', 'location', 'job_type', 'approval_status', 'experience_required', 'number_of_openings', 'posted_at')
    list_filter = ('job_type', 'experience_required', 'approval_status')
